...
function ContentPageLogic() {
        ...
        >
                      ...
                      <Col span={24}>
                        ...
                        {mixDesignData.documentPath ? (
                          ...
                          >
                            ...
                            ><Button onClick={openFile}>View Mix File</Button>
                              {mixDesignData.documentPath ? null : <Button
                                type="primary"
                                onClick={() => {
          ...
          {isEdit ? (
            <span style={{ color: "red" }}>
              Note: Click on the Image/File to update the image/file
            </span>
          ) : null}
        </Modal>
      </div>
  ...
  const openFile = () => {
    ...
    anchor.href = mixDesignData.documentPath; // Set the file path
    anchor.target = '_blank'; // Open in a new tab or window (optional)
    anchor.click(); // Simulate a click to open the file
